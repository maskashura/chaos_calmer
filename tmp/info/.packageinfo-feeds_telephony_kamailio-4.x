Source-Makefile: package/feeds/telephony/kamailio-4.x/Makefile
Package: kamailio4
Menu: 1
Submenu: Telephony
Version: 4.4.0-2
...
Submenu: Telephony
Version: 4.4.0-2
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread kamailio4 @BROKEN +kamailio4-mod-dialog +libhiredis +libevent2
Conflicts: 
Menu-Depends: 
Provides: 
Build-Depends: !BUILD_NLS:libiconv !BUILD_NLS:libintl
